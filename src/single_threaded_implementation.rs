    ...
    fn update(&mut self, ctx: &egui::Context, _: &mut eframe::Frame) {
        ...
        if self.inner_timer == None {
            ...
            if self.is_display_gpu_temperature {
                ...
                if self.gpu_temperature.len() > 600 {
            ...
            if self.is_display_cpu_temperature {
                ...
                if self.cpu_temperature.len() > 600 {
        ...
        std::thread::sleep(Duration::from_millis(12)); // обмежую "fps" програми, щоб заощадити ресурси комп'ютера
